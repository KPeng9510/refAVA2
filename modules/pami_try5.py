...
class Blipv2(nn.Module):
    def __init__(self,):
        ...
        self.mamba_bbox = nn.Sequential(nn.Linear(768, 256), Mamba(d_model=256), Mamba(d_model=256))
    ...
    def forward(self, key_frame, input_ids, token_type_ids, attention_mask, video, video_mask=None, bbox=None, ann=None, training=True):
        ...
        return loss, (cls_results + cls_results2)/3, (residual_boxes + residual_boxes2)/2, ann
