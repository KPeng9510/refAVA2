...
class RAVARDataset(Dataset):
    def __init__(
        ...
        self.annotation = []
        _, self.vis_processors, _ = load_model_and_preprocess(name="blip2_feature_extractor", model_type="pretrain", is_eval=False)
        #self.dino_processor = AutoProcessor.from_pretrained("IDEA-Research/grounding-dino-tiny")
        if training == 'train':
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/train_set_keyframe_crr_final.pkl', 'rb')
            self.key_bboxes = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/train_set_label_crr_final.pkl', 'rb')
            self.annotations_doc = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/train_set_description_crr_final.pkl','rb')
            self.captions = pkl.load(f)
            f.close()
        elif training == 'test':
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/test_set_keyframe_crr_final.pkl', 'rb')
            self.key_bboxes = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/test_set_label_crr_final.pkl', 'rb')
            self.annotations_doc = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/test_set_description_crr_final.pkl','rb')
            self.captions = pkl.load(f)
            f.close()      
        else:
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/val_set_keyframe_crr_final.pkl', 'rb')
            self.key_bboxes = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/val_set_label_crr_final.pkl', 'rb')
            self.annotations_doc = pkl.load(f)
            f.close()
            f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/ravar/data_preprocessing/val_set_description_crr_final.pkl','rb')
            self.captions = pkl.load(f)
            f.close()                   
